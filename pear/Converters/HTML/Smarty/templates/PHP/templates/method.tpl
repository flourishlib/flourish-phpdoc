{section name=methods loop=$methods}
	{if !$methods[methods].static}
		{if $show == 'summary'}
			<p>method {$methods[methods].function_call}, {$methods[methods].sdesc}</p>
		{else}
